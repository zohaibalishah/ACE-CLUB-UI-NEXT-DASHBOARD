...
export const CourtsRevenue = (): React.ReactElement => (
    <div className=" bg-boxColorDark border border-boxOutline rounded-xl">
        <div className="px-5 pt-4 flex-wrap gap-y-3 flex justify-between items-center">
            <Typography variant="h5">Courts Revenue</Typography>
        ...
        <div className="overflow-x-auto hideScroll">
            <div className="h-[260px] sm:h-[305px] min-w-[650px]">
